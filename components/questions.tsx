...
export const Questions = ({ questions, limit, category }: Props) => {
  ...
  return (
    <div className="bg-white p-3 shadow-md w-full mx-auto mt-4  md:mt-8 lg:mt-10 xl:mt-12 md:w-[90%] lg:w-[70%] max-w-4xl sm:rounded-lg">
